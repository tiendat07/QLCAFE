...
CREATE TABLE `thucuong` (
  ...
  CONSTRAINT `fk_thucuong_danhmuc` FOREIGN KEY (`MaThucUong`) REFERENCES `danhmuc` (`MaSanPham`)
...
INSERT INTO `thucuong` VALUES (2,1),(3,1);
...
-- Dump completed on 2020-06-03 12:20:26
